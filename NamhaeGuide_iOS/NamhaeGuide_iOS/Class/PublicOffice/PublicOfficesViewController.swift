...
class PublicOfficesViewController: UIViewController {
...
extension PublicOfficesViewController: UITableViewDelegate, UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        let detailVC = UIStoryboard(name: "PublicOffices", bundle: nil).instantiateViewController(withIdentifier: "PublicOfficesDetailViewController") as! PublicOfficesDetailViewController
